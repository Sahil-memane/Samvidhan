...
export default function MarkdownConverter() {
    ...
    const convertFile = () => {
        // make request to backend to convert file localhost:5000/markdown_converter
        ...
        fetch('http://localhost:5000/markdown_converter', {
            method: 'POST',
            body: formData
    ...
    const downloadMarkdown = () => {
        // make request to backend to download markdown file /get_markdown

        fetch('http://localhost:5000/get_markdown')
    ...
    return (
        <div>
            <h1 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-2">Markdown Converter</h1>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Upload your PDF, DOCX, TXT or any other file and we will convert it to markdown for you.</p>
            <div class="flex items-center justify-center w-full mb-3">
                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-600 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        {
                            file ? <p class="text-sm text-gray-500 dark:text-gray-400">Selected file: {file.name}</p> :
            ...
            <button type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-full" onClick={convertFile} disabled={!file || loading}>
...

            {
                ...
                <div className="flex flex-row justify-center mt-4">
                    ...
                    <button type="button" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        <FaFileZipper className="inline-block mr-2 h-4 w-4" />
