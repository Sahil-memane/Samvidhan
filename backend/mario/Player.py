...
class Player(object):
    def __init__(self, x_pos, y_pos):
        ...
        image_path = os.path.join(base_path, '../images/Mario/mario.png')
    ...
    def load_sprites(self):
            ...
            images_path = os.path.join(base_path, '../images/Mario')

            # List of image filenames
            filenames = [
                'mario.png', 'mario_move0.png', 'mario_move1.png', 'mario_move2.png',
                'mario_jump.png', 'mario_end.png', 'mario_end1.png', 'mario_st.png',
                'mario1.png', 'mario1_move0.png', 'mario1_move1.png', 'mario1_move2.png',
                'mario1_jump.png', 'mario1_end.png', 'mario1_end1.png', 'mario1_st.png',
                'mario2.png', 'mario2_move0.png', 'mario2_move1.png', 'mario2_move2.png',
                'mario2_jump.png', 'mario2_end.png', 'mario2_end1.png', 'mario2_st.png'
            ]

            # Load sprites
            self.sprites = [pg.image.load(os.path.join(images_path, filename)).convert_alpha() for filename in filenames]
            ...
            self.sprites.append(pg.image.load(os.path.join(images_path, 'mario_lvlup.png')).convert_alpha())

            # Power level changing, left
            self.sprites.append(pg.transform.flip(self.sprites[-1], 180, 0))

            # Death
            self.sprites.append(pg.image.load(os.path.join(images_path, 'mario_death.png')).convert_alpha())
